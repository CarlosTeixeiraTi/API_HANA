...
console.log('PRIMEIROS 50 IDENTIFICADORES:');
console.log('IDENTIFICADORES RETORNADOS:');
console.log(
    rastreios.map(x => x.identificador)
);
console.log(equipamentos.slice(0, 50));
...
module.exports = app => app.use('/SincronizarOrdensRastreio', router);